        ...
        <div className="prose prose-invert max-w-none space-y-8 text-primary-foreground/80">
          ...
          <section>
            ...
            <div className="bg-primary/50 p-6 rounded-lg border border-gold/20 space-y-2">
              ...
              <p><strong className="text-gold">Forme juridique :</strong> [À compléter - ex: SARL, SAS, Entreprise individuelle]</p>
              <p><strong className="text-gold">Capital social :</strong> [À compléter]</p>
              <p><strong className="text-gold">Siège social :</strong> 30 Avenue du Bois Labbé, Rennes, France</p>
              <p><strong className="text-gold">SIRET :</strong> [À compléter]</p>
              <p><strong className="text-gold">RCS :</strong> [À compléter]</p>
              <p><strong className="text-gold">Numéro de TVA intracommunautaire :</strong> [À compléter]</p>
            ...
            <p className="mt-4 text-sm italic text-primary-foreground/60">
              Note : Les informations marquées [À compléter] doivent être renseignées avec vos données légales réelles.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Le directeur de la publication du site est : <strong className="text-gold">[Nom du dirigeant]</strong>
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              un dispositif de médiation de la consommation. L&apos;entité de médiation retenue est :
            </p>
            <div className="bg-primary/50 p-6 rounded-lg border border-gold/20 mt-4 space-y-2">
              <p><strong className="text-gold">Médiateur :</strong> [À compléter - ex: Médiateur de la consommation CNPM]</p>
              <p><strong className="text-gold">Adresse :</strong> [À compléter]</p>
              <p><strong className="text-gold">Site web :</strong> [À compléter]</p>
            </div>
            <p className="mt-4 text-sm italic text-primary-foreground/60">
              Note : Vous devez choisir un médiateur de la consommation agréé et renseigner ses coordonnées.
            </p>
          </section>
